...
ARG NEXT_PUBLIC_COIN_DENOM
ARG NEXT_PUBLIC_COIN_MINIMAL_DENOM 
ARG NEXT_PUBLIC_COIN_DECIMALS
ARG NEXT_PUBLIC_COIN_GECKO_ID
...
ENV NEXT_PUBLIC_EXPONENT ${NEXT_PUBLIC_EXPONENT} 
...
ENV NEXT_PUBLIC_HYPERLINK ${NEXT_PUBLIC_HYPERLINK}
...
ENV NEXT_PUBLIC_COIN_DENOM ${NEXT_PUBLIC_COIN_DENOM}
ENV NEXT_PUBLIC_COIN_MINIMAL_DENOM ${NEXT_PUBLIC_COIN_MINIMAL_DENOM} 
ENV NEXT_PUBLIC_COIN_DECIMALS ${NEXT_PUBLIC_COIN_DECIMALS}
ENV NEXT_PUBLIC_COIN_GECKO_ID ${NEXT_PUBLIC_COIN_GECKO_ID}
